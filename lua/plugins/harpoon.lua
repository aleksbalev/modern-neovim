return {

  {
    ...
    keys = {
      ...
      { "<C-t>",      function() require("harpoon.ui").nav_file(2) end,             desc = "File 3" },
      { "<C-s>",      function() require("harpoon.ui").nav_file(2) end,             desc = "File 4" },
      { "<leader>1",  function() require("harpoon.term").gotoTerminal(1) end,       desc = "Terminal 1" },
      { "<leader>2",  function() require("harpoon.term").gotoTerminal(2) end,       desc = "Terminal 2" },
    },
    opts = {
      global_settings = {
        save_on_toggle = true,
